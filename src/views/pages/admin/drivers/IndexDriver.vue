...
const deleteData = () => {
    ...
    axios
        .delete(`${baseURL}/drivers/${dataIdBeingDeleted.value}`)
        .then(() => {
            ...
            <DataTable :value="retriviedData.data" v-model:expandedRows="expandedRows" tableStyle="min-width: 50rem">
                <template #header>
                    <div class="flex flex-wrap align-items-center justify-content-between gap-2">
                        <span class="text-xl text-900 font-bold">Motoristas</span>
                ...
                <Column field="license" sortable header="Carta de Condução"></Column>
                ...
                <Column header="Ações">
                    <template #body="slotProps">
                        <router-link :to="'/drivers/' + slotProps.data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link> | <router-link :to="'/drivers/' + slotProps.data.id"><i class="pi pi-eye"></i></router-link> |
                ...
                <template #footer> No total são {{ retriviedData.data ? retriviedData.total : 0 }} Motoristas. </template>
            </DataTable>
