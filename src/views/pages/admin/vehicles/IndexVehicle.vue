...
const deleteData = () => {
    ...
    axios
        .delete(`${baseURL}/vehicles/${dataIdBeingDeleted.value}`)
        .then(() => {
            ...
            <DataTable :value="retriviedData.data" v-model:expandedRows="expandedRows" tableStyle="min-width: 50rem">
                <template #header>
                    <div class="flex flex-wrap align-items-center justify-content-between gap-2">
                        <span class="text-xl text-900 font-bold">Veículos</span>
                ...
                <Column field="plate" sortable header="Matricula"></Column>
                <Column field="max_load" sortable header="Capacidade Máxima"></Column>
                ...
                <Column header="Ações">
                    <template #body="slotProps">
                        <router-link :to="'/vehicles/' + slotProps.data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link> | <router-link :to="'/vehicles/' + slotProps.data.id"><i class="pi pi-eye"></i></router-link> |
                ...
                <template #footer> No total são {{ retriviedData.data ? retriviedData.total : 0 }} Veículos. </template>
            </DataTable>
