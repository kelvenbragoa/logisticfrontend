...
const schema = yup.object({
    ...
    trela_id: yup.string().required().label('Province')
...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .put(`${baseURL}/vehicles/${router.currentRoute.value.params.id}`, values)
        .then((response) => {
            resetForm();
...
const getData = () => {
    axios
        .get(`${baseURL}/vehicles/${router.currentRoute.value.params.id}/edit`)
        .then((response) => {
            ...
            plate.value = retriviedData.value.plate;
            max_load.value = retriviedData.value.max_load;
            ...
            <form @submit="onSubmit">
                <div class="col-12 md:col-12">
                    <div class="card p-fluid">
                        <h5>Formulário para Editação de Veículoss</h5>
