    ...
    <div class="grid" v-if="!isLoadingDiv">
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Motoristas</span>
                        <div class="text-900 font-medium text-xl">{{ retriviedData.drivers }}</div>
                    </div>
                    <div class="flex align-items-center justify-content-center bg-blue-100 border-round" style="width: 2.5rem; height: 2.5rem">
                        <i class="pi pi-building text-blue-500 text-xl"></i>
                    </div>
                </div>
                <router-link to="/drivers"><i class="pi pi-eye text-blue-500 text-xl"></i></router-link>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Destinos</span>
                        <div class="text-900 font-medium text-xl">{{ retriviedData.destinations }}</div>
                    </div>
                    <div class="flex align-items-center justify-content-center bg-blue-100 border-round" style="width: 2.5rem; height: 2.5rem">
                        <i class="pi pi-users text-blue-500 text-xl"></i>
                    </div>
                </div>
                <router-link to="/destinations"><i class="pi pi-eye text-blue-500 text-xl"></i></router-link>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Veiculos</span>
                        <div class="text-900 font-medium text-xl">{{ retriviedData.vehicles }}</div>
                    </div>
                    <div class="flex align-items-center justify-content-center bg-blue-100 border-round" style="width: 2.5rem; height: 2.5rem">
                        <i class="pi pi-chart-bar text-blue-500 text-xl"></i>
                    </div>
                </div>
                <router-link to="/vehicles"><i class="pi pi-eye text-blue-500 text-xl"></i></router-link>
            </div>
        </div>
