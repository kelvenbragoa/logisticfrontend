        ...
        <div id="home" class="landing-wrapper overflow-hidden">
            ...
            <div id="home" class="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                <div class="text-center">
                    <h2 class="text-900 font-normal mb-2">Logistic</h2>
                    <span class="text-600 text-2xl">Logistic</span>
                </div>
<!-- 
                ...
                <div class="grid my-8 pt-2 md:pt-8">
                    <div class="col-12 lg:col-6 my-auto flex flex-column text-center lg:text-left lg:align-items-start">
                        ...
                        <h2 class="line-height-1 text-900 text-4xl font-normal">Logistic</h2>
                        <span class="text-700 text-2xl line-height-3 mr-0 md:mr-2" style="max-width: 650px"
                            >O sistema para registro de despesas de logística e atribuição de combustível é uma plataforma centralizada que permite às empresas monitorar e gerenciar todas as despesas relacionadas à logística, incluindo o consumo de combustível. Ele registra detalhadamente transações como aquisição de combustível, quilometragem percorrida e custos associados à manutenção de veículos. Com recursos avançados de relatórios e análise de dados, os gestores podem identificar padrões de consumo, calcular custos operacionais e tomar decisões informadas para melhorar a eficiência e reduzir os custos logísticos. Essa solução integrada ajuda as empresas a otimizar processos e melhorar sua competitividade no mercado. .</span
                        >
                    </div>
